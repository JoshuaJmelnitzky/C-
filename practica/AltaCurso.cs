...
namespace practica
{
    public partial class AltaCurso : Form
    {
        ...
        private void btnBuscarCarrera_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable tablaResultado = AD_Carreras.ObtenerCarrerasPorId(int.Parse(txtNroCarrera.Text));
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            bool resultado = AD_Cursos.AltaNuevoCurso(int.Parse(txtNroCurso.Text), txtNombre.Text.Trim(), txtDescripcion.Text.Trim(), int.Parse(txtNroCarrera.Text), listaAlumnos);
            ...
            {
                MessageBox.Show("Error al dar de alta nuevo curso");
            }
        }
    }
}
